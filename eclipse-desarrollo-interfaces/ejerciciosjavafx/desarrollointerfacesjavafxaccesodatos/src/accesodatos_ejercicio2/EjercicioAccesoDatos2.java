...
public class EjercicioAccesoDatos2 extends Application {

    @Override
    public void start(Stage primaryStage) {
        try {
            // Cargar el archivo FXML para la interfaz de usuario
            FXMLLoader loader = new FXMLLoader(getClass().getResource("Ejercicio2FXML.fxml")); 
            Parent root = loader.load();
            
            // Configura el título de la ventana
            primaryStage.setTitle("Visualizador de Videojuegos 2");
