...
public class VentanaMenuConSubMenu extends JFrame implements ActionListener {
    private JMenuBar mb;
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            VentanaMenuConSubMenu ventana = new VentanaMenuConSubMenu();
